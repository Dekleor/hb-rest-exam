...
- À la fin de l'examen, vous **devez** envoyer un zip de votre code *via* Discord et vous **pouvez** faire une PR à destination du projet d'origine (afin de faciliter mes retours pour la correction)
